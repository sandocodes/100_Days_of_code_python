...
# Example 1. Draw a Square 100 x 100
def turtle_square():
    for _ in range(4):
        tim.forward(100)
        tim.right(90)
...
# color_list = ["red", "blue", "green", "purple", "medium violet red", "chartreuse", "sienna", "indian red",
# "olive drab", "slate gray"] my_color = random.choice(color_list)
...
# Example 5. Draw a Spirograph - Number of circle, each with a radius of 100 in distance. Use random colors and the
# Turtle documentation Draw different number of circle Each circle with a radius of 100 in distance
...
# Installing Modules --> use python package index or pypi to install external modules (or modules no preloaded with
# python)
