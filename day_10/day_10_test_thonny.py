...
def compare_followers():
    ...
    while not is_game_over:
        ...
        if whos_higher == "A":
            ...
            if follower_countB > follower_countA or follower_countB == follower_countA:
                score += 1
                print(f"You're right! Current score: {score}")
                compare_followers()
            else:
